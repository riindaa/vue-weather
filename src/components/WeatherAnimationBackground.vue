<template>
  <div>
    <div icon="sunny" v-if="type === 'Clear'">
      <span class="sun"></span>
    </div>

    <div icon="snowy" v-if="type === 'Snow'">
      <ul>
        <li></li>
        <li></li>
        <li></li>
    ...
    <div icon="stormy" v-if="type === 'Thunderstorm' || type === 'Rain'">
    ...
    <div icon="cloudy" v-if="type === 'Clouds'">
      <span class="cloud"></span>
      <span class="cloud"></span>
    </div>

    <div icon="nightmoon" v-if="type === 'ClearNight'">
